...
import kabam.rotmg.lunarmarket.content.MemMarketInventoryItem;
import kabam.rotmg.lunarmarket.content.MemMarketItem;
import kabam.rotmg.lunarmarket.content.MemMarketSellItem;

import kabam.rotmg.lunarmarket.signals.MemMarketAddSignal;
import kabam.rotmg.lunarmarket.signals.MemMarketMyOffersSignal;
import kabam.rotmg.lunarmarket.signals.MemMarketRemoveSignal;
import kabam.rotmg.lunarmarket.utils.DialogUtils;
import kabam.rotmg.lunarmarket.utils.IconUtils;
...
public class MemMarketSellTab extends MemMarketTab
{
    ...
    private static const HOURS_24:String = "24 Hours";
    ...
    public function MemMarketSellTab(gameSprite:AGameSprite)
    {
        super(gameSprite);
        ...
        this.uptimeChoice_.setValue(HOURS_3);
