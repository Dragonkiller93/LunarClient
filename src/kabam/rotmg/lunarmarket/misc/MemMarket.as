...
package kabam.rotmg.lunarmarket.misc {
...
import kabam.rotmg.lunarmarket.tabs.MemMarketBuyTab;
import kabam.rotmg.lunarmarket.tabs.MemMarketSellTab;
import kabam.rotmg.lunarmarket.tabs.MemMarketTab;
...
public class MemMarket extends Sprite
{
    ...
    private var gameSprite_:AGameSprite;
    ...
    public function MemMarket(gameSprite:AGameSprite)
    {
        ...
        /* Draw buttons */
        //this.closeButton_ = PetsViewAssetFactory.returnCloseButton(modalWidth);
        this.closeButton_ = new TitleMenuOption("Close", 36, false);
        this.closeButton_.x = 800 / 2 - this.closeButton_.width / 2;
        this.closeButton_.y = 520;
        this.closeButton_.addEventListener(MouseEvent.CLICK, this.onClose);
        addChild(DisplayObject(this.closeButton_));
        ...
        this.creatorText_ = new SimpleText(8, 0xFFFFFF, false, 200);
