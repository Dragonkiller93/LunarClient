...
public class FameUtil {
    ...
    private static const adminCT:ColorTransform = new ColorTransform((0xFF/0xFF),(20/0xFF),(147/0xFF));
    ...
    public static function numStarsToImage(_arg_1:int):Sprite {
        var _local_2:Sprite = Sprite(new StarGraphic());
                ...
                if (_arg_1 < (ObjectLibrary.playerChars_.length * 3)) {
                    ...
                    if (_arg_1 < (ObjectLibrary.playerChars_.length * 4)) {
                        ...
                        if (_arg_1 < (ObjectLibrary.playerChars_.length * 5)) {
                            ...
                            if(_arg_1>(70) && _arg_1<81){
                                _local_2.transform.colorTransform= greenCT;
                            }
                            else{
                                if(_arg_1>80){
                                    _local_2.transform.colorTransform=adminCT;
                                }
                            }
                        }
                    }
